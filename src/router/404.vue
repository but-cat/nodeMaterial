<template>
	<div class="w-full h-full bg-blue-50 bg-opacity-50 relative overflow-hidden h-screen">
		...
		<div class="container mx-auto px-6 md:px-12 relative z-10 flex items-center py-32 xl:py-40">
			<div class="w-full font-mono flex flex-col items-center relative z-10">
				<h1 class="font-extrabold text-5xl text-center text-white leading-tight mt-4">没有这个页面</h1>
